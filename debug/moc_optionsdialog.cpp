...
static const char qt_meta_stringdata_OptionsDialog[] = {
    ...
    "from,to,rate\0updateExchangeRate(currency,currency,float)\0"
    "onAcceptChanges()\0"
};
...
void OptionsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->updateExchangeRate((*reinterpret_cast< const currency(*)>(_a[1])),(*reinterpret_cast< const currency(*)>(_a[2])),(*reinterpret_cast< const float(*)>(_a[3]))); break;
